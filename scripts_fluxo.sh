...
#Passo 4 - Testar pentaho. Após instalar JDK e editar as variáveis de ambiente, executar o arquivo spoon no diretório do pentaho
  spoon.sh

#Passo 5 - Fazer download do driver JDBC do banco de dados e mover para .../data-integrator/lib

#Passo 6 - Criar credenciais de acesso ao AWS (AWS Cli)
  ...
  aws configure #Configurar com os dados da AWS Key criada no console
